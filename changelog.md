...
- Custom CSS. Advanced users can now inject custom CSS directly from the plugin settings — no need to edit theme files.
Datepicker Colours
You can now customise the colour of the date picker to better match your brand.

#2.1.2
- Fix Person dropdown background color not setting from admin
- Fix date picker color not using color scheme